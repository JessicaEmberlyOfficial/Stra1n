...
# Letters are replaced as per ev order.
  ...
  _password_split = textwrap.wrap(_new_password, 55.2)
  print(_password_split)
  _password_split_1 = " -start- " + _password_split[1] + " -end- "
  _password_split_2 = " --start-- " + _password_split[2] + " --end-- "
  _password_split_3 = " ---start--- " + _password_split[3] + " ---end--- "
  _password_split_4 = " ----start---- " + _password_split[4] + " ----end---- "
  _password_split_5 = " -----start----- " + _password_split[5] + " -----end----- "
  _new_message_join = " ------start------ " + _new_message + " ------end------ "
  ...
  d6 = str(data_seg_6).join(_new_message_join)
  if os.path.isfile(os.getcwd() + "/data.stra1n") == True:
    os.system("clear")
    ...
    if dfep == "y":
      ...
      os.system("clear")
      name = input("Please enter a new name for your file? (e.g. Stra1n): ")
      if "." in name == true:
        os.system("clear")
        ...
        with open(os.getcwd() + name + ".stra1n", 'w') as file:
          file.write(d1 + d2 + d3 + d4 + d5 + d6)
          os.system("clear")
          if os.path.isfile(os.getcwd() + name + ".stra1n") == True:
            print("Encrypted file created at: " + os.getcwd() + "/data.txt")
          elif os.path.isfile(os.getcwd() + name + ".stra1n") == False:
            os.system("clear")
            ...
            os.system("clear")
            return encrypt()
  elif os.path.isfile(os.getcwd() + "/data.stra1n") == False:
